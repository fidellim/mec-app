...
<div class="row justify-content-center align-items-center py-5" style="min-height: 70vh;">
    <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5">
        <div class="content-card p-4 p-md-5 shadow-sm text-center">
            <div class="display-5 fw-bold mb-2">503</div>
            <h1 class="h4 mb-2">Service temporarily unavailable</h1>
            <p class="text-muted mb-4">
                The platform is temporarily unavailable. Please check back shortly.
            </p>
