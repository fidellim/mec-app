                        ...
                        <div class="sidebar-nav-group">
                            ...
                            <div id="sidebarApprovalsNav" @class(['sidebar-nav-items', 'collapse', 'show' => $approvalsOpen])>
                                ...
                                @if(auth()->user()->role === 'hod')
                                    ...
                                    <a href="{{ route('hod.leave-entitlements.index') }}" @class(['active' => request()->routeIs('hod.leave-entitlements.*')]) title="Leave Entitlements"><img class="sidebar-icon" src="{{ asset('images/sidebar/weekly-periods.svg') }}" alt=""><span class="sidebar-label">Leave Entitlements</span></a>
