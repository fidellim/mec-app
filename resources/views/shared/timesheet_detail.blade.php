<div class="content-card p-3 mb-3">
    <div class="row g-3">
        <div class="col-md-3"><div class="text-muted">Employee</div><strong>{{ $timesheet->user->name }}</strong></div>
...
<div class="content-card p-3">
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            <thead><tr><th>Date</th><th>Day</th><th>Project</th><th>Regular</th><th>Overtime</th><th>Description</th><th>Remarks</th></tr></thead>
            <tbody>
