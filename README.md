...
- `L100 - Annual Leave`, `L110 - Sick Leave`, `L160 - Maternity Leave`, `L170 - Parental Leave`, Philippines `L180 - Bereavement / Compassionate Leave`, and Philippines-only `L190 - Service Incentive Leave` have entitlement limits. UAE `L180` uses separate calendar-year balances for spouse and immediate-family bereavement. Super Admin sets UAE and Philippines defaults in **Leave Settings**, including UAE sick and maternity maximum claimable calendar-day limits, and can set per-user annual overrides in **Manage Users**.
...
- UAE bereavement leave requires the employee to select the relationship to the deceased. Spouse and immediate-family usage are tracked as separate calendar-year balances and refresh each January 1.
