...
4. Employee saves as draft or submits.
5. Submitted timesheets are locked for the employee.
6. HOD approves or rejects department timesheets.
7. Rejected timesheets show the rejection comment and become editable by the employee.
8. Admin and Super Admin monitor all records and export CSV data.
