...
Annual, sick, maternity, parental, Philippines bereavement / compassionate, and Philippines service incentive leave have calendar-year entitlement limits. UAE bereavement / compassionate leave uses separate spouse and immediate-family calendar-year balances.
...
- Annual, sick, maternity, parental, Philippines bereavement / compassionate, and Philippines service incentive leave entitlements are tracked and shown when the employee is eligible. UAE bereavement remains available as `L180` and is shown as spouse and immediate-family balances. Maternity leave is available only when the employee gender is set to Female. Parental leave is available only when the employee marital status is set to Married. Service incentive leave is available only to Philippines employees.
