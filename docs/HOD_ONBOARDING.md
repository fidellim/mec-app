...
The **Head of Department Dashboard** shows counts for the current open period:
...
2. Filter by status, employee, week number, or year if needed.
...
You can approve or reject employee timesheets in your own department.

You cannot:

- Approve or reject your own timesheet.
- Approve or reject another Head of Department's timesheet.
- Review departments outside your assigned department.
- Approve or reject timesheets that are not currently submitted.

## Submission Tracker

Use **Submission Tracker** to monitor department submission progress.

1. Go to **Submission Tracker**.
2. Choose a weekly period.
3. Select **View Period**.
4. Review each employee's period status.
5. Use **Send Reminder** for one missing employee.
6. Use **Notify All Missing** to remind all missing employees for that period.
...
- You receive an email when an employee submits or resubmits a timesheet for review.
- You receive an email when an employee recalls a submitted timesheet.
